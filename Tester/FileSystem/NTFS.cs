...
namespace AmbientOS.FileSystem.NTFS
{
    ...
    public class NTFSTest
    {
        ...
        /// </summary>
        private static IEnumerable<long> Diff(AmbientOS.FileSystem.NTFS.NTFSAttribute attr1, NTFSAttribute attr2, TestFlags options)
        {
        ...
        /// </summary>
        private static IEnumerable<Tuple<NTFSAttribute, long>> Diff(NTFS volume1, NTFS volume2, TestFlags options)
        {
